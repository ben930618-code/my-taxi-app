...
app.get('/driver', (req, res) => {
    const htmlLines = [
        ...
        '                const safeAddr = encodeURIComponent(ord.targetAddress);',
        ...
        '                    "<button onclick=\\"openTextNav(\'" + safeAddr + "\')\\" style=\'margin-top:5px; padding:6px 12px; font-size:13px; background:#007bff; color:white; border:none; border-radius:3px; cursor:pointer; font-weight:bold;\'>🧭 開啟地圖導航</button>" +',
        '                "</div>";',
        '            });',
